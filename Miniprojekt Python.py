...
elif (Svar != "1" or Svar.lower != "x" or Svar != "2") and Rätt_svar1 == 1: # Om svaret inte är 1, X eller 2 påminner programmet om det.
    print("Fel, rätt svar är 1, " + Alternativ[0] + ".")
    print("Kom ihåg att svara 1, X eller 2.")
elif (Svar != "1" or Svar.lower != "x" or Svar != "2") and Rätt_svar1 == 1 and Rätt_svarX == 1:
    print("Fel, rätt svar är X, " + Alternativ[0] + ".")
    print("Kom ihåg att svara 1, X eller 2.")
elif (Svar != "1" or Svar.lower != "x" or Svar != "2") and Rätt_svar1 != 1 and Rätt_svarX != 1:
    print("Fel, rätt svar är 2, " + Alternativ[0] + ".")
...
elif (Svar != "1" or Svar.lower != "x" or Svar != "2") and Rätt_svar1 == 1:
    print("Fel, rätt svar är 1, " + Alternativ[0] + ".")
    print("Kom ihåg att svara 1, X eller 2.")
elif (Svar != "1" or Svar.lower != "x" or Svar != "2") and Rätt_svar1 == 1 and Rätt_svarX == 1:
    print("Fel, rätt svar är X, " + Alternativ[0] + ".")
...
if Svar.lower() == "x" and Rätt_svar1 != 1 and Rätt_svarX == 1:
    ...
    print("Fel, rätt svar är, " + Alternativ[0] + ".")
    print("Kom ihåg att svara 1, X eller 2.")
